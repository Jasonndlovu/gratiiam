...
import { CategoriesService, Product, ProductsService, Category  } from '@comp/products';
...
export class ProductsFormComponent implements OnInit {
  ...
  private _getCategories() {this.categoriesService.getCategories().subscribe((categories) => {this.categories = categories;});}
  ...
  onSubmit() {
    ...
    if (this.editmode) {this._updateProduct(productFormData);} else {this._addProduct(productFormData);}
  ...
  //   for (const imagesPaths of this.mulitpleImages) {
  //     formdata.append('files',imagesPaths)
  //   }
